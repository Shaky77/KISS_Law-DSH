...
import { attributeCall, extractCommand, DELETION_LAYERS } from './attribution.mjs';  // path-1 attribution + its deletion-layer set (vocabulary owned by attribution; engine only consumes)
